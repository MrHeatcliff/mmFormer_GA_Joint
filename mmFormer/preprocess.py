...
src_path = '/tran_tien_dat_112/workspace/sanglequang/brats2018/versions/10/MICCAI_BraTS_2018_Data_Training'
tar_path = '/tran_tien_dat_112/workspace/sanglequang/brats2018/versions/10/BRATS2018_Training_none_npy'
...
for file_name in name_list:
    ...
    flair, flair_header = medio.load(os.path.join(src_path, file_name, case_id+'_flair.nii'))
    t1ce, t1ce_header = medio.load(os.path.join(src_path, file_name, case_id+'_t1ce.nii'))
    t1, t1_header = medio.load(os.path.join(src_path, file_name, case_id+'_t1.nii'))
    t2, t2_header = medio.load(os.path.join(src_path, file_name, case_id+'_t2.nii'))
    ...
    seg, seg_header = medio.load(os.path.join(src_path, file_name, case_id+'_seg.nii'))
